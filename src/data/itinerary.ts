...
export interface ItineraryItem {
  ...
  /** Drive segment FROM the previous stop TO this one */
  drive?: { duration: string; distance: string };
  /** Google Maps search query – opens in Maps app when tapped */
  mapQuery?: string;
}
...
export const ITINERARY_BY_DAY: DayItinerary[] = [
  ...
  // ── May 26 ─────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      { id: '26-3', time: '19:00', title: 'Riverside Market 晚餐', tag: '餐饮', tagColor: TAG.dining, category: 'dining', image: IMAGES.riverside_market,
        mapQuery: 'Riverside Market Christchurch New Zealand',
        description: '当地人强烈推荐的室内美食广场，各国美食应有尽有，环境轻松。营业至约 21:00。' },
      { id: '26-4', time: '20:30', title: 'COUNTDOWN 超市补给', tag: '购物', tagColor: TAG.activity, category: 'activity', image: IMAGES.countdown,
        mapQuery: 'Countdown Moorhouse Ave Christchurch New Zealand',
  ...
  // ── May 27 ─────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      { id: '27-1', time: '09:00', title: '出发 → 杰拉尔丁（Geraldine）', tag: '驾车', tagColor: TAG.drive, category: 'activity', image: IMAGES.geraldine,
        mapQuery: "Barker's Food Store Geraldine New Zealand",
        description: '车程约 1.5 小时，在 Barker\'s Food Store & Eatery 停留喝咖啡、免费试吃各种果酱。建议在基督城或杰拉尔丁加满油。' },
      { id: '27-2', time: '12:00', title: 'Fairlie Bakehouse — 必吃新西兰第一派', tag: '餐饮', tagColor: TAG.dining, category: 'dining', image: IMAGES.fairlie_bakehouse,
        drive: { duration: '30min', distance: '40km' },
        mapQuery: 'Fairlie Bakehouse Fairlie New Zealand',
      ...
      { id: '27-3', time: '13:30', title: '抵达蒂卡普湖，放行李休息', tag: '抵达', tagColor: TAG.arrive, category: 'arrival', image: IMAGES.tekapo_lake,
        drive: { duration: '45min', distance: '43km' },
        mapQuery: 'Lake Tekapo New Zealand',
        description: '5 月湖边风大且冷，记得穿上防风保暖衣物。入住 Skyblue Tekapo。' },
      { id: '27-4', time: '14:30', title: '约翰山天文台 & Astro Café', tag: '景点', tagColor: TAG.activity, category: 'activity', image: IMAGES.astro_cafe,
        mapQuery: 'Astro Cafe Mount John Observatory Lake Tekapo New Zealand',
        description: '开车上山（需支付约 NZD 8–15 过路费）。Astro Café 被《孤独星球》誉为"地球上地理位置最好的咖啡馆之一"，营业至 16:30。' },
      { id: '27-5', time: '17:00', title: '好牧羊人教堂夕阳', tag: '景点', tagColor: TAG.activity, category: 'activity', image: IMAGES.church_good_shepherd,
      ...
      { id: '27-6', time: '18:30', title: 'Kohan Restaurant 三文鱼晚餐', tag: '餐饮', tagColor: TAG.dining, category: 'dining', image: IMAGES.kohan_restaurant,
        mapQuery: 'Kohan Restaurant Lake Tekapo New Zealand',
        description: '营业 17:30–20:00，提供当地高山冷水三文鱼刺身及三文鱼丼，人气很高，建议下午抵达时先去订位。' },
      { id: '27-7', time: '20:00', title: '国际暗天空保护区观星', tag: '星空', tagColor: TAG.stargazing, category: 'activity', image: IMAGES.tekapo_stargazing,
        mapQuery: 'Tekapo Springs New Zealand',
  ...
  // ── May 28 ─────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      { id: '28-1', time: '09:30', title: '离开蒂卡普湖，途经普卡基湖', tag: '驾车', tagColor: TAG.drive, category: 'activity', image: IMAGES.lake_pukaki,
        mapQuery: 'Lake Pukaki Lookout New Zealand',
        description: '车程约 1.5 小时。备齐物资：库克山村内物资有限且较贵，建议在蒂卡普湖补满油并买好零食和午餐。' },
      { id: '28-2', time: '10:30', title: 'Mt Cook Alpine Salmon 三文鱼店', tag: '餐饮', tagColor: TAG.dining, category: 'dining', image: IMAGES.alpine_salmon,
        drive: { duration: '1h', distance: '80km' },
        mapQuery: 'Mt Cook Alpine Salmon Lake Pukaki New Zealand',
      ...
      { id: '28-3', time: '13:30', title: '塔斯曼冰川景观步道', tag: '徒步', tagColor: TAG.activity, category: 'activity', image: IMAGES.tasman_glacier,
        drive: { duration: '30min', distance: '55km' },
        mapQuery: 'Tasman Glacier Viewpoint Mount Cook New Zealand',
      ...
      { id: '28-4', time: '15:00', title: '胡克谷步道 — 走到第一座吊桥', tag: '徒步', tagColor: TAG.activity, category: 'activity', image: IMAGES.hooker_valley,
        mapQuery: 'Hooker Valley Track White Horse Hill Mount Cook New Zealand',
      ...
      { id: '28-5', time: '18:00', title: '酒店晚餐 & 库克山观星', tag: '餐饮', tagColor: TAG.dining, category: 'dining', image: IMAGES.hermitage_hotel,
        mapQuery: 'The Hermitage Hotel Mount Cook New Zealand',
  ...
  // ── May 29 ─────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      { id: '29-1', time: '08:30', title: '清晨塔斯曼冰川步道（可选）', tag: '徒步', tagColor: TAG.activity, category: 'activity', image: IMAGES.tasman_morning,
        mapQuery: 'Tasman Glacier Viewpoint Mount Cook New Zealand',
        description: '清晨光线照在雪山上非常漂亮，往返仅需 1 小时。精力充沛可在出发前完成，清晨视野最佳。' },
      { id: '29-2', time: '10:00', title: 'High Country Salmon — 特威泽尔三文鱼', tag: '餐饮', tagColor: TAG.dining, category: 'dining', image: IMAGES.high_country_salmon,
        drive: { duration: '45min', distance: '65km' },
        mapQuery: 'High Country Salmon Twizel New Zealand',
      ...
      { id: '29-3', time: '11:30', title: '奥马拉马粘土悬崖 (Clay Cliffs)', tag: '景点', tagColor: TAG.activity, category: 'activity', image: IMAGES.clay_cliffs,
        drive: { duration: '20min', distance: '25km' },
        mapQuery: 'Clay Cliffs Omarama New Zealand',
      ...
      { id: '29-4', time: '12:30', title: '林迪斯山口顶峰观景台', tag: '景点', tagColor: TAG.activity, category: 'activity', image: IMAGES.lindis_pass,
        drive: { duration: '25min', distance: '35km' },
        mapQuery: 'Lindis Pass Summit New Zealand',
      ...
      { id: '29-5', time: '14:00', title: '抵达瓦纳卡 — 孤树打卡', tag: '景点', tagColor: TAG.arrive, category: 'arrival', image: IMAGES.wanaka_tree,
        drive: { duration: '45min', distance: '65km' },
        mapQuery: 'That Wanaka Tree New Zealand',
        description: '瓦纳卡孤树（That Wanaka Tree）是新西兰被拍摄次数最多的树，建议傍晚日落前往，光线最美。入住 Alpine Motel。湖边有成熟步道，可租自行车绕湖骑行。' },
      { id: '29-6', time: '15:30', title: '迷宫世界 (Puzzling World)', tag: '亲子', tagColor: TAG.activity, category: 'activity', image: IMAGES.puzzling_world,
        mapQuery: 'Puzzling World Wanaka New Zealand',
  ...
  // ── May 30 ─────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      { id: '30-1', time: '09:30', title: '文胸围栏 & 卡德罗纳酒店', tag: '打卡', tagColor: TAG.activity, category: 'activity', image: IMAGES.cardrona_bra_fence,
        mapQuery: 'Cardrona Bra Fence New Zealand',
      ...
      { id: '30-2', time: '11:00', title: '皇冠山脉顶峰观景台', tag: '景点', tagColor: TAG.activity, category: 'activity', image: IMAGES.crown_range,
        drive: { duration: '15min', distance: '15km' },
        mapQuery: 'Crown Range Summit Queenstown New Zealand',
      ...
      { id: '30-3', time: '11:45', title: '箭镇历史小镇午餐', tag: '餐饮', tagColor: TAG.dining, category: 'dining', image: IMAGES.arrowtown,
        drive: { duration: '25min', distance: '30km' },
        mapQuery: 'Arrowtown New Zealand',
        description: '19 世纪淘金热英伦风情小镇。Arrowtown Bakery 著名肉派，Buckingham St 上的 The Remarkable Sweet Shop 糖果店孩子必去。华人淘金者定居点旧址环境清幽。' },
      { id: '30-4', time: '14:45', title: '卡瓦劳大桥 — 世界蹦极发源地', tag: '极限', tagColor: TAG.activity, category: 'activity', image: IMAGES.kawarau_bridge,
        drive: { duration: '15min', distance: '20km' },
        mapQuery: 'Kawarau Bridge Bungy Queenstown New Zealand',
        description: '即使不敢跳，在看台观看别人纵身一跳也非常刺激！车程从箭镇约 15 分钟。' },
      { id: '30-5', time: '15:45', title: '抵达皇后镇，办理入住', tag: '抵达', tagColor: TAG.arrive, category: 'arrival', image: IMAGES.queenstown_lakefront,
        drive: { duration: '20min', distance: '15km' },
        mapQuery: 'Holiday Inn Queenstown Frankton Road New Zealand',
        description: '今天是周六，Remarkables Market 仅周六举行，可顺道逛一圈。入住 Holiday Inn Queenstown Frankton Road。市中心停车贵，建议停酒店步行进城。' },
      { id: '30-6', time: '17:00', title: '天空缆车 + Luge 滑板车', tag: '景点', tagColor: TAG.activity, category: 'activity', image: IMAGES.skyline_gondola,
  ...
  // ── May 31 ─────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      { id: '31-2', time: '09:45', title: 'Bennett\'s Bluff 最佳观景点', tag: '景点', tagColor: TAG.activity, category: 'activity', image: IMAGES.bennetts_bluff,
        mapQuery: "Bennett's Bluff Lookout Glenorchy New Zealand",
        description: '全程最著名的观景台，瓦卡蒂普湖呈"之"字形弯曲，背景雄伟雪山，视觉冲击力极强，必停拍照。' },
      { id: '31-3', time: '10:30', title: '格林诺奇红房子 & 湖畔栈道', tag: '景点', tagColor: TAG.activity, category: 'activity', image: IMAGES.glenorchy_road,
        mapQuery: 'Glenorchy Waterfront Shed New Zealand',
      ...
      { id: '31-4', time: '12:00', title: "Mrs Woolly's General Store 午餐", tag: '餐饮', tagColor: TAG.dining, category: 'dining', image: IMAGES.mrs_woollys,
        mapQuery: "Mrs Woolly's General Store Glenorchy New Zealand",
        description: '格林诺奇镇上为数不多的餐厅之一，轻松温馨。可选继续深入 20 公里碎石路到达"Paradise"地方，寻访魔戒艾辛格取景地。' },
      { id: '31-5', time: '14:00', title: '返回皇后镇 & 湖畔漫步', tag: '返回', tagColor: TAG.arrive, category: 'activity', image: IMAGES.queenstown_lakefront,
        mapQuery: 'Queenstown Lakefront New Zealand',
  ...
  // ── Jun 1 ──────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      { id: '1-1', time: '08:30', title: '出发皇后镇 → 克伦威尔水果小镇', tag: '驾车', tagColor: TAG.drive, category: 'activity', image: IMAGES.cromwell_fruit,
        mapQuery: 'Jones Family Fruit Stall Cromwell New Zealand',
        description: '尽早出发为后面留足时间。Jones Family Fruit Stall 是必停站，购买当地新鲜水果和纯手工水果冰淇淋（Real Fruit Ice Cream），著名的巨型水果地标小镇。' },
      { id: '1-2', time: '11:00', title: 'High Country Salmon 三文鱼午餐', tag: '餐饮', tagColor: TAG.dining, category: 'dining', image: IMAGES.high_country_salmon_lunch,
        drive: { duration: '45min', distance: '70km' },
        mapQuery: 'High Country Salmon Omarama New Zealand',
      ...
      { id: '1-3', time: '12:30', title: '象石群 (Elephant Rocks)', tag: '景点', tagColor: TAG.activity, category: 'activity', image: IMAGES.elephant_rocks,
        drive: { duration: '30min', distance: '40km' },
        mapQuery: 'Elephant Rocks Duntroon New Zealand',
      ...
      { id: '1-5', time: '日落', title: '小蓝企鹅归巢 — 世界最小企鹅', tag: '野生动物', tagColor: TAG.activity, category: 'activity', image: IMAGES.blue_penguin,
        mapQuery: 'Oamaru Blue Penguin Colony New Zealand',
  ...
  // ── Jun 2 ──────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      { id: '2-2', time: '12:00', title: 'Timaru — Caroline Bay 午餐 & 游乐场', tag: '亲子', tagColor: TAG.activity, category: 'activity', image: IMAGES.caroline_bay,
        drive: { duration: '1h', distance: '85km' },
        mapQuery: 'Caroline Bay Park Timaru New Zealand',
        description: '南岛最出名的免费海滨儿童游乐场，有秋千、大滑梯，4 岁小孩一定会玩疯。海边咖啡馆吃午饭，或买 Pie 到公园野餐。' },
      { id: '2-3', time: '15:00', title: 'Rakaia — 大三文鱼雕像打卡', tag: '景点', tagColor: TAG.activity, category: 'activity', image: IMAGES.rakaia_salmon,
        drive: { duration: '45min', distance: '65km' },
        mapQuery: 'Rakaia Giant Salmon Sculpture New Zealand',
        description: '新西兰"喷射艇之都"，标志性的大三文鱼雕像是孩子的好拍照对象，旁边 Rakaia Domain 有小型游乐设施，面包房可买三文鱼派和热饮。' },
      { id: '2-4', time: '16:30', title: '抵达基督城，入住 Golden Hotel', tag: '抵达', tagColor: TAG.arrive, category: 'arrival', image: IMAGES.golden_hotel,
        drive: { duration: '45min', distance: '55km' },
        mapQuery: 'Golden Hotel Christchurch New Zealand',
        description: '顺利返回基督城，完成最后一段长途驾驶。办理入住 Golden Hotel，休整片刻。' },
      { id: '2-5', time: '19:00', title: 'Riverside Market 晚餐', tag: '餐饮', tagColor: TAG.dining, category: 'dining', image: IMAGES.riverside_market,
        mapQuery: 'Riverside Market Christchurch New Zealand',
  ...
  // ── Jun 3 ──────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      { id: '3-1', time: '09:30', title: '基督城植物园 & 雅芳河泛舟', tag: '景点', tagColor: TAG.activity, category: 'activity', image: IMAGES.botanic_gardens,
      ...
      { id: '3-2', time: '11:30', title: '玛格丽特·马希游乐场 — 南半球最大', tag: '亲子', tagColor: TAG.activity, category: 'activity', image: IMAGES.margaret_mahy,
        mapQuery: 'Margaret Mahy Family Playground Christchurch New Zealand',
        description: '南半球最大的户外游乐场！双人飞天滑索、巨大攀爬塔、喷水嬉水区、超级滑梯……旁边有咖啡馆和干净厕所，孩子绝对玩到不想走。' },
      { id: '3-3', time: '14:00', title: '纸教堂 & New Regent Street', tag: '景点', tagColor: TAG.activity, category: 'activity', image: IMAGES.cardboard_cathedral,
        mapQuery: 'Cardboard Cathedral Christchurch New Zealand',
        description: '纸教堂（Cardboard Cathedral）是地震后用纸板建造的临时大教堂，充满创意。彩色西班牙风格的 New Regent Street 适合拍照和喝咖啡。Canterbury Museum 了解南岛历史。' },
      { id: '3-4', time: '18:00', title: '还车 & 入住 Sudima 机场酒店', tag: '住宿', tagColor: TAG.hotel, category: 'accommodation', image: IMAGES.sudima_hotel,
        mapQuery: 'Sudima Christchurch Airport Hotel New Zealand',
        description: '在规定时间前完成还车手续，Sudima Christchurch Airport 酒店步行即可到机场，为明早出发做好准备。' },
      { id: '3-5', time: '18:30', title: 'Spitfire Square 告别晚餐', tag: '餐饮', tagColor: TAG.dining, category: 'dining', image: IMAGES.spitfire_square,
        mapQuery: 'Spitfire Square Christchurch Airport New Zealand',
  ...
  // ── Jun 4 ──────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      { id: '4-2', time: '08:40', title: '起飞 → 中转 → 返回新加坡', tag: '飞行', tagColor: TAG.flight, category: 'departure', image: IMAGES.singapore_return,
