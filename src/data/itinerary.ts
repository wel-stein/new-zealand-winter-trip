...
export const ITINERARY_BY_DAY: DayItinerary[] = [
  ...
  // ── May 26 ─────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      { id: '26-3', time: '19:00', title: 'Riverside Market 晚餐', tag: '餐饮', tagColor: TAG.dining, category: 'dining',
  ...
  // ── May 27 ─────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      { id: '27-3', time: '13:30', title: '抵达蒂卡普湖，放行李休息', tag: '抵达', tagColor: TAG.arrive, category: 'arrival',
        description: '5 月湖边风大且冷，记得穿上防风保暖衣物。入住 Skyblue Tekapo。' },
      { id: '27-4', time: '14:30', title: '约翰山天文台 & Astro Café', tag: '景点', tagColor: TAG.activity, category: 'activity',
        description: '开车上山（需支付约 NZD 8–15 过路费）。Astro Café 被《孤独星球》誉为"地球上地理位置最好的咖啡馆之一"，营业至 16:30。' },
      { id: '27-5', time: '17:00', title: '好牧羊人教堂夕阳', tag: '景点', tagColor: TAG.activity, category: 'activity',
      ...
      { id: '27-7', time: '20:00', title: '国际暗天空保护区观星', tag: '星空', tagColor: TAG.stargazing, category: 'activity',
  ...
  // ── May 28 ─────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      { id: '28-2', time: '10:30', title: 'Mt Cook Alpine Salmon 三文鱼店', tag: '餐饮', tagColor: TAG.dining, category: 'dining',
        description: '位于普卡基湖畔，可买到新鲜三文鱼刺身，边看湛蓝湖景边享用。彼得观景点（Peter\'s Lookout）在这附近，是拍"通往雪山笔直公路"的最佳位置。' },
      { id: '28-3', time: '13:30', title: '塔斯曼冰川景观步道', tag: '徒步', tagColor: TAG.activity, category: 'activity',
        description: '往返约 1 小时，需爬一段台阶，终点可俯瞰塔斯曼冰川湖和蓝色浮冰，下午走比较暖和。' },
      { id: '28-4', time: '15:00', title: '胡克谷步道 — 走到第一座吊桥', tag: '徒步', tagColor: TAG.activity, category: 'activity',
        description: '【最推荐】全程来回 3–4 小时，但带小孩走到第一座吊桥即可（约 15–20 分钟），俯瞰穆勒湖冰川水，景色壮观。起点：White Horse Hill 停车场，中途有公共厕所。' },
      { id: '28-5', time: '18:00', title: '酒店晚餐 & 库克山观星', tag: '餐饮', tagColor: TAG.dining, category: 'dining',
  ...
  // ── May 29 ─────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      { id: '29-1', time: '08:30', title: '清晨塔斯曼冰川步道（可选）', tag: '徒步', tagColor: TAG.activity, category: 'activity',
        description: '清晨光线照在雪山上非常漂亮，往返仅需 1 小时。精力充沛可在出发前完成。' },
      { id: '29-2', time: '10:00', title: '出发 → 奥马拉马，经粘土悬崖', tag: '驾车', tagColor: TAG.drive, category: 'activity',
        description: '粘土悬崖（Clay Cliffs）是小众震撼景点（需支付约 NZD 5 入场费），巨大尖塔状岩层仿佛置身火星。建议在特威泽尔（Twizel）或奥马拉马加满油。' },
      { id: '29-3', time: '12:30', title: '林迪斯山口顶峰观景台', tag: '景点', tagColor: TAG.activity, category: 'activity',
        description: '全程最高海拔点，山坡覆盖金黄色 Tussock 草丛，在山顶停车场拍照留念。注意：冬季弯道多、可能有黑冰，谨慎驾驶。' },
      { id: '29-4', time: '14:00', title: '抵达瓦纳卡 — 孤树打卡', tag: '景点', tagColor: TAG.arrive, category: 'arrival',
        description: '瓦纳卡孤树（That Wanaka Tree）是新西兰被拍摄次数最多的树，建议傍晚日落前往，光线最美。入住 Alpine Motel。' },
      { id: '29-5', time: '15:30', title: '迷宫世界 (Puzzling World)', tag: '亲子', tagColor: TAG.activity, category: 'activity',
        description: '充满错觉艺术和大型木制迷宫，4 岁小孩也非常适合！大厅/咖啡厅免费，3D 大迷宫需购票。著名的倾斜塔和错觉洗手间可免费拍照。' },
    ],
  },
  ...
  // ── May 30 ─────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      { id: '30-2', time: '11:00', title: '皇冠山脉顶峰观景台', tag: '景点', tagColor: TAG.activity, category: 'activity',
      ...
      { id: '30-4', time: '14:45', title: '卡瓦劳大桥 — 世界蹦极发源地', tag: '极限', tagColor: TAG.activity, category: 'activity',
        description: '即使不敢跳，在看台观看别人纵身一跳也非常刺激！车程从箭镇约 15 分钟。' },
      { id: '30-5', time: '15:45', title: '抵达皇后镇，办理入住', tag: '抵达', tagColor: TAG.arrive, category: 'arrival',
        description: '今天是周六，Remarkables Market 仅周六举行，可顺道逛一圈。入住 Holiday Inn Queenstown Frankton Road。市中心停车贵，建议停酒店步行进城。' },
      { id: '30-6', time: '17:00', title: '天空缆车 + Luge 滑板车', tag: '景点', tagColor: TAG.activity, category: 'activity',
  ...
  // ── May 31 ─────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      { id: '31-2', time: '09:45', title: 'Bennett\'s Bluff 最佳观景点', tag: '景点', tagColor: TAG.activity, category: 'activity',
        description: '全程最著名的观景台，瓦卡蒂普湖呈"之"字形弯曲，背景雄伟雪山，视觉冲击力极强，必停拍照。' },
      { id: '31-3', time: '10:30', title: '格林诺奇红房子 & 湖畔栈道', tag: '景点', tagColor: TAG.activity, category: 'activity',
      ...
      { id: '31-5', time: '14:00', title: '返回皇后镇 & 湖畔漫步', tag: '返回', tagColor: TAG.arrive, category: 'activity',
  ...
  // ── Jun 1 ──────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      { id: '1-3', time: '12:30', title: '象石群 (Elephant Rocks)', tag: '景点', tagColor: TAG.activity, category: 'activity',
        description: '沿怀塔基河旁的神奇巨石群，仿佛远古巨象矗立大地，是免费自然奇观，也是电影取景地。' },
      { id: '1-4', time: '15:30', title: '抵达奥马鲁 — 维多利亚历史区', tag: '抵达', tagColor: TAG.arrive, category: 'arrival',
      ...
      { id: '1-5', time: '日落', title: '小蓝企鹅归巢 — 世界最小企鹅', tag: '野生动物', tagColor: TAG.activity, category: 'activity',
  ...
  // ── Jun 2 ──────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      { id: '2-2', time: '12:00', title: 'Timaru — Caroline Bay 午餐 & 游乐场', tag: '亲子', tagColor: TAG.activity, category: 'activity',
        description: '南岛最出名的免费海滨儿童游乐场，有秋千、大滑梯，4 岁小孩一定会玩疯。海边咖啡馆吃午饭，或买 Pie 到公园野餐。' },
      { id: '2-3', time: '15:00', title: 'Rakaia — 大三文鱼雕像打卡', tag: '景点', tagColor: TAG.activity, category: 'activity',
        description: '新西兰"喷射艇之都"，标志性的大三文鱼雕像是孩子的好拍照对象，旁边 Rakaia Domain 有小型游乐设施，面包房可买三文鱼派和热饮。' },
      { id: '2-4', time: '16:30', title: '抵达基督城，办理入住', tag: '抵达', tagColor: TAG.arrive, category: 'arrival',
        description: '顺利返回基督城，完成最后一段长途驾驶。' },
      { id: '2-5', time: '19:00', title: 'Riverside Market 告别晚餐', tag: '餐饮', tagColor: TAG.dining, category: 'dining',
        description: '再次光临第一天晚上的美食广场，在轻松的氛围中回味这段旅程。' },
    ],
  },
  ...
  // ── Jun 3 ──────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      { id: '3-2', time: '11:30', title: '玛格丽特·马希游乐场 — 南半球最大', tag: '亲子', tagColor: TAG.activity, category: 'activity',
        description: '南半球最大的户外游乐场！双人飞天滑索、巨大攀爬塔、喷水嬉水区、超级滑梯……旁边有咖啡馆和干净厕所，孩子绝对玩到不想走。' },
      { id: '3-3', time: '14:00', title: '纸教堂 & New Regent Street', tag: '景点', tagColor: TAG.activity, category: 'activity',
