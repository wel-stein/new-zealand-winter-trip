...
export const ITINERARY_BY_DAY: DayItinerary[] = [
  ...
  // ── May 30 ─────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      { id: '30-6', time: '17:00', title: '天空缆车 + Luge 滑板车', tag: '景点', tagColor: TAG.activity, category: 'activity', imageUri: IMG.gondola,
  ...
  // ── May 31 ─────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      { id: '31-5', time: '14:00', title: '返回皇后镇 & 湖畔漫步', tag: '返回', tagColor: TAG.arrive, category: 'activity', imageUri: IMG.queenstown,
