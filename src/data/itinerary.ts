...
export const ITINERARY_BY_DAY: DayItinerary[] = [
  ...
  // ── May 26 ─────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      { id: '26-1', time: '16:25', title: '抵达基督城国际机场', tag: '抵达', tagColor: TAG.arrive, category: 'arrival', image: IMAGES.riverside_market,
  ...
  // ── May 29 ─────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      { id: '29-4', time: '12:30', title: '林迪斯山口顶峰观景台', tag: '景点', tagColor: TAG.activity, category: 'activity', image: IMAGES.clay_cliffs,
        description: '全程最高海拔点，山坡覆盖金黄色 Tussock 草丛，在山顶停车场拍照留念。注意：冬季弯道多、可能有黑冰，谨慎驾驶。Tarras 小镇可停下喝咖啡。' },
      { id: '29-5', time: '14:00', title: '抵达瓦纳卡 — 孤树打卡', tag: '景点', tagColor: TAG.arrive, category: 'arrival', image: IMAGES.tekapo_lake,
  ...
  // ── May 30 ─────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      { id: '30-3', time: '11:45', title: '箭镇历史小镇午餐', tag: '餐饮', tagColor: TAG.dining, category: 'dining', image: IMAGES.crown_range,
      ...
      { id: '30-7', time: '19:00', title: 'Fergburger — 传说中的汉堡', tag: '餐饮', tagColor: TAG.dining, category: 'dining', image: IMAGES.skyline_gondola,
