...
function pexels(id: number): string {
  return `https://images.pexels.com/photos/${id}/pexels-photo-${id}.jpeg?auto=compress&cs=tinysrgb&w=800&h=400&dpr=1&fit=crop`;
}

const IMG = {
  sg_airport:     pexels(12429032),
  chch_city:      pexels(280221),
  chch_botanic:   pexels(3610321),
  chch_cardboard: pexels(3610321),
  playground:     pexels(280221),
  tekapo_lake:    pexels(33977061),
  tekapo_church:  pexels(33977061),
  tekapo_stars:   pexels(114251),
  mt_cook:        pexels(20486661),
  pukaki:         pexels(870711),
  hooker:         pexels(18847728),
  tasman:         pexels(13328047),
  wanaka_tree:    pexels(31893344),
  puzzling:       pexels(31893344),
  crown_range:    pexels(30234158),
  arrowtown:      pexels(19145743),
  queenstown:     pexels(28970675),
  gondola:        pexels(2670898),
  kawarau:        pexels(18847728),
  fergburger:     pexels(15010311),
  glenorchy_road: pexels(870711),
  bennetts:       pexels(870711),
  glenorchy:      pexels(18815907),
  cromwell:       pexels(20486661),
  elephant:       pexels(20486661),
  oamaru_vic:     pexels(3610321),
  oamaru_penguin: pexels(2670898),
  lindis:         pexels(30234158),
  clay_cliffs:    pexels(20486661),
  rakaia:         pexels(20486661),
  caroline:       pexels(870711),
  hero:           pexels(870711),
};
...
export const ITINERARY_BY_DAY: DayItinerary[] = [
  ...
  // ── May 27 ─────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      { id: '27-3', time: '13:30', title: '抵达蒂卡普湖，放行李休息', tag: '抵达', tagColor: TAG.arrive, category: 'arrival', imageUri: 'https://media.istockphoto.com/id/1550421607/photo/lake-tekapo.jpg?s=612x612&w=0&k=20&c=ydobpTOhodDpzzSVh7A4LX75kEzeYhAFqzZD_zfLrxo=',
        description: '5 月湖边风大且冷，记得穿上防风保暖衣物。入住 Skyblue Tekapo。' },
      { id: '27-4', time: '14:30', title: '约翰山天文台 & Astro Café', tag: '景点', tagColor: TAG.activity, category: 'activity', imageUri: 'https://res.klook.com/image/upload/w_750,h_469,c_fill,q_85/w_80,x_15,y_15,g_south_west,l_Klook_water_br_trans_yhcmh3/activities/xc7thc3ueuexoe6mxzzz.jpg',
        description: '开车上山（需支付约 NZD 8–15 过路费）。Astro Café 被《孤独星球》誉为"地球上地理位置最好的咖啡馆之一"，营业至 16:30。' },
      { id: '27-5', time: '17:00', title: '好牧羊人教堂夕阳', tag: '景点', tagColor: TAG.activity, category: 'activity', imageUri: 'https://images.vocus.cc/2fbb0aa8-6fb0-4561-8bfb-19554da9620a.jpg',
        description: '5 月底日落约在 17:15，教堂窗户正对着湖泊雪山，是经典打卡点。旁边还有著名的牧羊犬铜像。开放时间 10:00–16:00，日落后可在外拍照。' },
      { id: '27-6', time: '18:30', title: 'Kohan Restaurant 三文鱼晚餐', tag: '餐饮', tagColor: TAG.dining, category: 'dining', imageUri: 'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/2b/12/83/75/caption.jpg?w=1100&h=1100&s=1',
        description: '营业 17:30–20:00，提供当地高山冷水三文鱼刺身及三文鱼丼，人气很高，建议下午抵达时先去订位。' },
      { id: '27-7', time: '20:00', title: '国际暗天空保护区观星', tag: '星空', tagColor: TAG.stargazing, category: 'activity', imageUri: 'https://res.klook.com/image/upload/w_750,h_469,c_fill,q_85/w_80,x_15,y_15,g_south_west,l_Klook_water_br_trans_yhcmh3/activities/xc7thc3ueuexoe6mxzzz.jpg',
  ...
  // ── May 28 ─────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      { id: '28-1', time: '09:30', title: '离开蒂卡普湖，途经普卡基湖', tag: '驾车', tagColor: TAG.drive, category: 'activity', imageUri: 'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/14/fa/61/13/lake-pukaki.jpg?w=900&h=500&s=1',
        description: '车程约 1.5 小时。备齐物资：库克山村内物资有限且较贵，建议在蒂卡普湖补满油并买好零食和午餐。' },
      { id: '28-2', time: '10:30', title: 'Mt Cook Alpine Salmon 三文鱼店', tag: '餐饮', tagColor: TAG.dining, category: 'dining', imageUri: 'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/1b/e7/9c/f4/shop-counter.jpg?w=900&h=500&s=1',
        description: '位于普卡基湖畔，可买到新鲜三文鱼刺身，边看湛蓝湖景边享用。彼得观景点（Peter\'s Lookout）在这附近，是拍"通往雪山笔直公路"的最佳位置。' },
      { id: '28-3', time: '13:30', title: '塔斯曼冰川景观步道', tag: '徒步', tagColor: TAG.activity, category: 'activity', imageUri: 'https://res.klook.com/image/upload/w_750,h_469,c_fill,q_85/w_80,x_15,y_15,g_south_west,l_Klook_water_br_trans_yhcmh3/activities/o37auooedcjodlayjfcr.jpg',
      ...
      { id: '28-5', time: '18:00', title: '酒店晚餐 & 库克山观星', tag: '餐饮', tagColor: TAG.dining, category: 'dining', imageUri: 'https://hermitage.canterbury-hotels.com/data/Images/OriginalPhoto/17094/1709482/1709482867/aoraki-mount-cook-the-hermitage-hotel-mt-cook-image-48.JPEG',
  ...
  // ── May 29 ─────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      { id: '29-1', time: '08:30', title: '清晨塔斯曼冰川步道（可选）', tag: '徒步', tagColor: TAG.activity, category: 'activity', imageUri: 'https://cdn.getyourguide.com/image/format=auto,fit=crop,gravity=auto,quality=60,width=1210,dpr=1/tour_img/5d0807d1eabc4.jpeg',
        description: '清晨光线照在雪山上非常漂亮，往返仅需 1 小时。精力充沛可在出发前完成，清晨视野最佳。' },
      { id: '29-2', time: '10:00', title: 'High Country Salmon — 特威泽尔三文鱼', tag: '餐饮', tagColor: TAG.dining, category: 'dining', imageUri: 'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/10/7a/9b/7b/fresh-high-country-sashimi.jpg?w=1200&h=-1&s=1',
        description: '位于特威泽尔（Twizel）附近的高山三文鱼农场，可亲手喂鱼并品尝新鲜刺身，是库克山→瓦纳卡途中的必停站。建议在此加满油。' },
      { id: '29-3', time: '11:30', title: '奥马拉马粘土悬崖 (Clay Cliffs)', tag: '景点', tagColor: TAG.activity, category: 'activity', imageUri: 'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/2b/85/49/b4/caption.jpg?w=900&h=500&s=1',
      ...
      { id: '29-6', time: '15:30', title: '迷宫世界 (Puzzling World)', tag: '亲子', tagColor: TAG.activity, category: 'activity', imageUri: 'https://media-cdn.tripadvisor.com/media/photo-s/0a/03/df/36/photo1jpg.jpg',
  ...
  // ── May 30 ─────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      { id: '30-1', time: '09:30', title: '文胸围栏 & 卡德罗纳酒店', tag: '打卡', tagColor: TAG.activity, category: 'activity', imageUri: 'https://celiamrg.com/wp-content/uploads/20190826002805_41-768x576.jpg',
        description: '出发约 20 分钟到达 Cardrona Bra Fence，挂满数千个彩色内衣，支持乳腺癌研究。正对面的卡德罗纳历史酒店（建于 1863 年）后花园带篝火，适合喝咖啡。' },
      { id: '30-2', time: '11:00', title: '皇冠山脉顶峰观景台', tag: '景点', tagColor: TAG.activity, category: 'activity', imageUri: 'https://img.fun-life.com.tw/webp/new-zealand/crown-range-road-scenic-lookout/crown-range-road-scenic-lookout.jpg.webp',
      ...
      { id: '30-4', time: '14:45', title: '卡瓦劳大桥 — 世界蹦极发源地', tag: '极限', tagColor: TAG.activity, category: 'activity', imageUri: 'https://res.klook.com/image/upload/fl_lossy.progressive,q_65/w_1080/w_80,x_15,y_15,g_south_west,l_Klook_water_br_trans_yhcmh3/activities/wyimurpzp018abxcbluf.webp',
        description: '即使不敢跳，在看台观看别人纵身一跳也非常刺激！车程从箭镇约 15 分钟。' },
      { id: '30-5', time: '15:45', title: '抵达皇后镇，办理入住', tag: '抵达', tagColor: TAG.arrive, category: 'arrival', imageUri: IMG.queenstown,
        description: '今天是周六，Remarkables Market 仅周六举行，可顺道逛一圈。入住 Holiday Inn Queenstown Frankton Road。市中心停车贵，建议停酒店步行进城。' },
      { id: '30-6', time: '17:00', title: '天空缆车 + Luge 滑板车', tag: '景点', tagColor: TAG.activity, category: 'activity', imageUri: 'https://media-cdn.tripadvisor.com/media/attractions-splice-spp-674x446/07/c2/5f/65.jpg',
  ...
  // ── May 31 ─────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      { id: '31-1', time: '09:00', title: '驱车格林诺奇全景公路', tag: '驾车', tagColor: TAG.drive, category: 'activity', imageUri: 'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/01/f0/c1/13/scenic-overlook-of-lake.jpg?w=1000&h=-1&s=1',
        description: '这条 45 分钟的湖畔公路被评为"世界十大景观公路"之一，左手湛蓝湖水，右手巍峨雪山。建议在皇后镇加好油再出发。' },
      { id: '31-2', time: '09:45', title: 'Bennett\'s Bluff 最佳观景点', tag: '景点', tagColor: TAG.activity, category: 'activity', imageUri: 'https://runningwithmiles.boardingarea.com/wp-content/uploads/2022/02/AdobeStock_187428164-scaled.jpeg',
        description: '全程最著名的观景台，瓦卡蒂普湖呈"之"字形弯曲，背景雄伟雪山，视觉冲击力极强，必停拍照。' },
      { id: '31-3', time: '10:30', title: '格林诺奇红房子 & 湖畔栈道', tag: '景点', tagColor: TAG.activity, category: 'activity', imageUri: IMG.glenorchy,
      ...
      { id: '31-4', time: '12:00', title: "Mrs Woolly's General Store 午餐", tag: '餐饮', tagColor: TAG.dining, category: 'dining', imageUri: 'https://img.gototravel.tw/webp/2019/newzealand/Queentown/Mrs-Woollys-General-Store/Mrs-Woollys-General-Store-21.jpg.webp',
        description: '格林诺奇镇上为数不多的餐厅之一，轻松温馨。可选继续深入 20 公里碎石路到达"Paradise"地方，寻访魔戒艾辛格取景地。' },
      { id: '31-5', time: '14:00', title: '返回皇后镇 & 湖畔漫步', tag: '返回', tagColor: TAG.arrive, category: 'activity', imageUri: 'https://www.petitfute.com/medias/mag/41846/originale/AdobeStock_238212130-1024x683.jpeg',
  ...
  // ── Jun 1 ──────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      { id: '1-1', time: '08:30', title: '出发皇后镇 → 克伦威尔水果小镇', tag: '驾车', tagColor: TAG.drive, category: 'activity', imageUri: 'https://journey.tw/wp-content/uploads/2023-05-21-120416-59.jpg',
        description: '尽早出发为后面留足时间。Jones Family Fruit Stall 是必停站，购买当地新鲜水果和纯手工水果冰淇淋（Real Fruit Ice Cream），著名的巨型水果地标小镇。' },
      { id: '1-2', time: '11:00', title: 'High Country Salmon 三文鱼午餐', tag: '餐饮', tagColor: TAG.dining, category: 'dining', imageUri: 'https://scontent.fmkz1-2.fna.fbcdn.net/v/t39.30808-6/489820282_9785441701511972_7823311896509728759_n.jpg?_nc_cat=110&ccb=1-7&_nc_sid=aa7b47&_nc_ohc=bexX29bilmEQ7kNvwH-F8-X&_nc_oc=AdrxrhxGvwsx3of9NJCYN8oWYQCpdoitqd8cIbuxhGedZ-0oJ9kc8eFKZdf2cotrR1YHWBMDA4GJLZ77KCaKF3Bo&_nc_zt=23&_nc_ht=scontent.fmkz1-2.fna&_nc_gid=2Zg7DsAsNUjalzdGQumwDQ&_nc_ss=7b2a8&oh=00_Af4IvkCxrXNme1mEt4a7KL5R-0YymZUAV3UkJATIMoS5Yg&oe=6A17BEB0',
        description: '奥马拉马（Omarama）附近的高山三文鱼农场，可亲手喂鱼并品尝新鲜刺身。也可在此顺道参观粘土悬崖（Clay Cliffs）。' },
      { id: '1-3', time: '12:30', title: '象石群 (Elephant Rocks)', tag: '景点', tagColor: TAG.activity, category: 'activity', imageUri: 'https://img.fun-life.com.tw/webp/new-zealand/oamaru-elephant-rocks/DSC09791.jpg.webp',
      ...
      { id: '1-5', time: '日落', title: '小蓝企鹅归巢 — 世界最小企鹅', tag: '野生动物', tagColor: TAG.activity, category: 'activity', imageUri: 'https://www.fittravel.com.au/wp-content/uploads/phillip-island-1.jpg',
  ...
  // ── Jun 2 ──────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      { id: '2-2', time: '12:00', title: 'Timaru — Caroline Bay 午餐 & 游乐场', tag: '亲子', tagColor: TAG.activity, category: 'activity', imageUri: 'https://www.cplay.co.nz/images/LetsPlay-CPlay-Caroline-Bay-Playground-HeroImage-220304.jpg',
        description: '南岛最出名的免费海滨儿童游乐场，有秋千、大滑梯，4 岁小孩一定会玩疯。海边咖啡馆吃午饭，或买 Pie 到公园野餐。' },
      { id: '2-3', time: '15:00', title: 'Rakaia — 大三文鱼雕像打卡', tag: '景点', tagColor: TAG.activity, category: 'activity', imageUri: 'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/16/79/34/6a/salmon-statue.jpg?w=1100&h=-1&s=1',
        description: '新西兰"喷射艇之都"，标志性的大三文鱼雕像是孩子的好拍照对象，旁边 Rakaia Domain 有小型游乐设施，面包房可买三文鱼派和热饮。' },
      { id: '2-4', time: '16:30', title: '抵达基督城，入住 Golden Hotel', tag: '抵达', tagColor: TAG.arrive, category: 'arrival', imageUri: 'https://cf.bstatic.com/xdata/images/hotel/max1024x768/337365837.jpg?k=10d87027273f4f6f90a98c1a07cc4c6d0d8129f06da5257f6c2cf95bd680769b&o=',
