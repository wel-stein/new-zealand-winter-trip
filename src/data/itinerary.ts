...
// ─── Wikimedia Commons photo URLs ────────────────────────────────────────────
const IMG = {
  sg_airport: 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/5d/Changi_Airport%2C_Terminal_2%2C_Departure_Hall_3%2C_Dec_05.JPG/800px-Changi_Airport%2C_Terminal_2%2C_Departure_Hall_3%2C_Dec_05.JPG',
  chch_city: 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/ab/Christchurch_City_Skyline.jpg/800px-Christchurch_City_Skyline.jpg',
  chch_botanic: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/c8/Christchurch_Botanic_Gardens_01.jpg/800px-Christchurch_Botanic_Gardens_01.jpg',
  chch_cardboard: 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e5/Cardboard_Cathedral_front.jpg/800px-Cardboard_Cathedral_front.jpg',
  playground_mahy: 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/66/Margaret_Mahy_Family_Playground.jpg/800px-Margaret_Mahy_Family_Playground.jpg',
  tekapo_church: 'https://upload.wikimedia.org/wikipedia/commons/thumb/d/d4/Lake_Tekapo_Church_of_the_Good_Shepherd_001.JPG/800px-Lake_Tekapo_Church_of_the_Good_Shepherd_001.JPG',
  tekapo_lake: 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/5e/Lake_tekapo.jpg/800px-Lake_tekapo.jpg',
  tekapo_stars: 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/5d/Good_Shepherd_Church_Lake_Tekapo.jpg/800px-Good_Shepherd_Church_Lake_Tekapo.jpg',
  mt_cook: 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/29/Aoraki-Mount_Cook_from_Hooker_Valley.jpg/800px-Aoraki-Mount_Cook_from_Hooker_Valley.jpg',
  pukaki: 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/66/Lake_Pukaki_Mount_Cook.jpg/800px-Lake_Pukaki_Mount_Cook.jpg',
  hooker: 'https://upload.wikimedia.org/wikipedia/commons/thumb/f/fe/Hooker_Valley_Track_swingbridge.jpg/800px-Hooker_Valley_Track_swingbridge.jpg',
  tasman: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/4a/Tasman_Glacier_Lake.jpg/800px-Tasman_Glacier_Lake.jpg',
  wanaka_tree: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/82/Wanaka_tree.jpg/800px-Wanaka_tree.jpg',
  puzzling: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/96/Puzzling_World.jpg/800px-Puzzling_World.jpg',
  crown_range: 'https://upload.wikimedia.org/wikipedia/commons/thumb/d/d0/Crown_Range_Road.jpg/800px-Crown_Range_Road.jpg',
  arrowtown: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/c1/Arrowtown_in_Autumn.jpg/800px-Arrowtown_in_Autumn.jpg',
  queenstown_view: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/85/Queenstown_from_Bobs_Peak.jpg/800px-Queenstown_from_Bobs_Peak.jpg',
  queenstown_gondola: 'https://upload.wikimedia.org/wikipedia/commons/thumb/3/37/Queenstown_Skyline_Gondola.jpg/800px-Queenstown_Skyline_Gondola.jpg',
  kawarau: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/b8/Kawarau_Bridge_Bungy_Jumping.jpg/800px-Kawarau_Bridge_Bungy_Jumping.jpg',
  fergburger: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/93/Fergburger_Queenstown.jpg/800px-Fergburger_Queenstown.jpg',
  glenorchy_road: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/98/Road_to_Glenorchy.jpg/800px-Road_to_Glenorchy.jpg',
  bennetts: 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/76/Bennetts_Bluff_Lookout.jpg/800px-Bennetts_Bluff_Lookout.jpg',
  glenorchy_wharf: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/b2/Glenorchy_Wharf.jpg/800px-Glenorchy_Wharf.jpg',
  oamaru_penguin: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/40/Oamaru_Blue_Penguin_Colony.jpg/800px-Oamaru_Blue_Penguin_Colony.jpg',
  oamaru_vic: 'https://upload.wikimedia.org/wikipedia/commons/thumb/f/f2/Oamaru_Victorian_Precinct.jpg/800px-Oamaru_Victorian_Precinct.jpg',
  elephant: 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e4/Elephant_Rocks_New_Zealand.jpg/800px-Elephant_Rocks_New_Zealand.jpg',
  steampunk: 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/6c/Steampunk_HQ_Oamaru.jpg/800px-Steampunk_HQ_Oamaru.jpg',
  cromwell: 'https://upload.wikimedia.org/wikipedia/commons/thumb/f/f5/Cromwell_Fruit_Sculpture.jpg/800px-Cromwell_Fruit_Sculpture.jpg',
  lindis: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/16/Lindis_Pass.jpg/800px-Lindis_Pass.jpg',
  clay_cliffs: 'https://upload.wikimedia.org/wikipedia/commons/thumb/f/ff/Clay_Cliffs_Omarama.jpg/800px-Clay_Cliffs_Omarama.jpg',
  rakaia: 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/01/Big_Salmon_Rakaia.jpg/800px-Big_Salmon_Rakaia.jpg',
  caroline: 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/7a/Caroline_Bay_Timaru.jpg/800px-Caroline_Bay_Timaru.jpg',
};
...
export const ITINERARY_BY_DAY: DayItinerary[] = [
  // ── May 25 ─────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      { id: '25-1', time: '18:00', title: '抵达新加坡机场 T2', tag: '出发', tagColor: TAG.arrive, category: 'arrival', imageUri: IMG.sg_airport,
  ...
  // ── May 26 ─────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      { id: '26-1', time: '16:25', title: '抵达基督城国际机场', tag: '抵达', tagColor: TAG.arrive, category: 'arrival', imageUri: IMG.chch_city,
      ...
      { id: '26-3', time: '19:00', title: 'Riverside Market 晚餐', tag: '餐饮', tagColor: TAG.dining, category: 'dining', imageUri: IMG.chch_city,
  ...
  // ── May 27 ─────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      { id: '27-3', time: '13:30', title: '抵达蒂卡普湖，放行李休息', tag: '抵达', tagColor: TAG.arrive, category: 'arrival', imageUri: IMG.tekapo_lake,
        description: '5 月湖边风大且冷，记得穿上防风保暖衣物。入住 Skyblue Tekapo。' },
      { id: '27-4', time: '14:30', title: '约翰山天文台 & Astro Café', tag: '景点', tagColor: TAG.activity, category: 'activity', imageUri: IMG.tekapo_lake,
        description: '开车上山（需支付约 NZD 8–15 过路费）。Astro Café 被《孤独星球》誉为"地球上地理位置最好的咖啡馆之一"，营业至 16:30。' },
      { id: '27-5', time: '17:00', title: '好牧羊人教堂夕阳', tag: '景点', tagColor: TAG.activity, category: 'activity', imageUri: IMG.tekapo_church,
      ...
      { id: '27-7', time: '20:00', title: '国际暗天空保护区观星', tag: '星空', tagColor: TAG.stargazing, category: 'activity', imageUri: IMG.tekapo_stars,
  ...
  // ── May 28 ─────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      { id: '28-1', time: '09:30', title: '离开蒂卡普湖，途经普卡基湖', tag: '驾车', tagColor: TAG.drive, category: 'activity', imageUri: IMG.pukaki,
        description: '车程约 1.5 小时。备齐物资：库克山村内物资有限且较贵，建议在蒂卡普湖补满油并买好零食和午餐。' },
      { id: '28-2', time: '10:30', title: 'Mt Cook Alpine Salmon 三文鱼店', tag: '餐饮', tagColor: TAG.dining, category: 'dining', imageUri: IMG.pukaki,
        description: '位于普卡基湖畔，可买到新鲜三文鱼刺身，边看湛蓝湖景边享用。彼得观景点（Peter\'s Lookout）在这附近，是拍"通往雪山笔直公路"的最佳位置。' },
      { id: '28-3', time: '13:30', title: '塔斯曼冰川景观步道', tag: '徒步', tagColor: TAG.activity, category: 'activity', imageUri: IMG.tasman,
        description: '往返约 1 小时，需爬一段台阶，终点可俯瞰塔斯曼冰川湖和蓝色浮冰，下午走比较暖和。' },
      { id: '28-4', time: '15:00', title: '胡克谷步道 — 走到第一座吊桥', tag: '徒步', tagColor: TAG.activity, category: 'activity', imageUri: IMG.hooker,
        description: '【最推荐】全程来回 3–4 小时，但带小孩走到第一座吊桥即可（约 15–20 分钟），俯瞰穆勒湖冰川水，景色壮观。起点：White Horse Hill 停车场，中途有公共厕所。' },
      { id: '28-5', time: '18:00', title: '酒店晚餐 & 库克山观星', tag: '餐饮', tagColor: TAG.dining, category: 'dining', imageUri: IMG.mt_cook,
  ...
  // ── May 29 ─────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      { id: '29-1', time: '08:30', title: '清晨塔斯曼冰川步道（可选）', tag: '徒步', tagColor: TAG.activity, category: 'activity', imageUri: IMG.mt_cook,
      ...
      { id: '29-3', time: '11:30', title: '奥马拉马粘土悬崖 (Clay Cliffs)', tag: '景点', tagColor: TAG.activity, category: 'activity', imageUri: IMG.clay_cliffs,
        description: '小众震撼景点（需支付约 NZD 5 入场费），巨大尖塔状粘土岩层仿佛置身异世界或火星表面，令人叹为观止。' },
      { id: '29-4', time: '12:30', title: '林迪斯山口顶峰观景台', tag: '景点', tagColor: TAG.activity, category: 'activity', imageUri: IMG.lindis,
        description: '全程最高海拔点，山坡覆盖金黄色 Tussock 草丛，在山顶停车场拍照留念。注意：冬季弯道多、可能有黑冰，谨慎驾驶。Tarras 小镇可停下喝咖啡。' },
      { id: '29-5', time: '14:00', title: '抵达瓦纳卡 — 孤树打卡', tag: '景点', tagColor: TAG.arrive, category: 'arrival', imageUri: IMG.wanaka_tree,
        description: '瓦纳卡孤树（That Wanaka Tree）是新西兰被拍摄次数最多的树，建议傍晚日落前往，光线最美。入住 Alpine Motel。湖边有成熟步道，可租自行车绕湖骑行。' },
      { id: '29-6', time: '15:30', title: '迷宫世界 (Puzzling World)', tag: '亲子', tagColor: TAG.activity, category: 'activity', imageUri: IMG.puzzling,
  ...
  // ── May 30 ─────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      { id: '30-2', time: '11:00', title: '皇冠山脉顶峰观景台', tag: '景点', tagColor: TAG.activity, category: 'activity', imageUri: IMG.crown_range,
        description: '可俯瞰之字形蜿蜒公路、箭镇和皇后镇盆地全景，视觉冲击极强。' },
      { id: '30-3', time: '11:45', title: '箭镇历史小镇午餐', tag: '餐饮', tagColor: TAG.dining, category: 'dining', imageUri: IMG.arrowtown,
        description: '19 世纪淘金热英伦风情小镇。Arrowtown Bakery 著名肉派，Buckingham St 上的 The Remarkable Sweet Shop 糖果店孩子必去。华人淘金者定居点旧址环境清幽。' },
      { id: '30-4', time: '14:45', title: '卡瓦劳大桥 — 世界蹦极发源地', tag: '极限', tagColor: TAG.activity, category: 'activity', imageUri: IMG.kawarau,
        description: '即使不敢跳，在看台观看别人纵身一跳也非常刺激！车程从箭镇约 15 分钟。' },
      { id: '30-5', time: '15:45', title: '抵达皇后镇，办理入住', tag: '抵达', tagColor: TAG.arrive, category: 'arrival', imageUri: IMG.queenstown_view,
        description: '今天是周六，Remarkables Market 仅周六举行，可顺道逛一圈。入住 Holiday Inn Queenstown Frankton Road。市中心停车贵，建议停酒店步行进城。' },
      { id: '30-6', time: '17:00', title: '天空缆车 + Luge 滑板车', tag: '景点', tagColor: TAG.activity, category: 'activity', imageUri: IMG.queenstown_gondola,
        description: '俯瞰瓦卡蒂普湖和卓越山脉的最佳视角。家庭 3 次 Luge 套票（2 大 2 小）NZD 254。4 岁以下可成人带双人同乘，额外约 NZD 5。建议提前在官网或 Klook 购票。' },
      { id: '30-7', time: '19:00', title: 'Fergburger — 传说中的汉堡', tag: '餐饮', tagColor: TAG.dining, category: 'dining', imageUri: IMG.fergburger,
  ...
  // ── May 31 ─────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      { id: '31-1', time: '09:00', title: '驱车格林诺奇全景公路', tag: '驾车', tagColor: TAG.drive, category: 'activity', imageUri: IMG.glenorchy_road,
        description: '这条 45 分钟的湖畔公路被评为"世界十大景观公路"之一，左手湛蓝湖水，右手巍峨雪山。建议在皇后镇加好油再出发。' },
      { id: '31-2', time: '09:45', title: 'Bennett\'s Bluff 最佳观景点', tag: '景点', tagColor: TAG.activity, category: 'activity', imageUri: IMG.bennetts,
        description: '全程最著名的观景台，瓦卡蒂普湖呈"之"字形弯曲，背景雄伟雪山，视觉冲击力极强，必停拍照。' },
      { id: '31-3', time: '10:30', title: '格林诺奇红房子 & 湖畔栈道', tag: '景点', tagColor: TAG.activity, category: 'activity', imageUri: IMG.glenorchy_wharf,
      ...
      { id: '31-5', time: '14:00', title: '返回皇后镇 & 湖畔漫步', tag: '返回', tagColor: TAG.arrive, category: 'activity', imageUri: IMG.queenstown_view,
  ...
  // ── Jun 1 ──────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      { id: '1-1', time: '08:30', title: '出发皇后镇 → 克伦威尔水果小镇', tag: '驾车', tagColor: TAG.drive, category: 'activity', imageUri: IMG.cromwell,
      ...
      { id: '1-3', time: '12:30', title: '象石群 (Elephant Rocks)', tag: '景点', tagColor: TAG.activity, category: 'activity', imageUri: IMG.elephant,
        description: '沿怀塔基河旁的神奇巨石群，仿佛远古巨象矗立大地，是免费自然奇观，也是电影取景地。' },
      { id: '1-4', time: '15:30', title: '抵达奥马鲁 — 维多利亚历史区', tag: '抵达', tagColor: TAG.arrive, category: 'arrival', imageUri: IMG.oamaru_vic,
      ...
      { id: '1-5', time: '日落', title: '小蓝企鹅归巢 — 世界最小企鹅', tag: '野生动物', tagColor: TAG.activity, category: 'activity', imageUri: IMG.oamaru_penguin,
  ...
  // ── Jun 2 ──────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      { id: '2-2', time: '12:00', title: 'Timaru — Caroline Bay 午餐 & 游乐场', tag: '亲子', tagColor: TAG.activity, category: 'activity', imageUri: IMG.caroline,
        description: '南岛最出名的免费海滨儿童游乐场，有秋千、大滑梯，4 岁小孩一定会玩疯。海边咖啡馆吃午饭，或买 Pie 到公园野餐。' },
      { id: '2-3', time: '15:00', title: 'Rakaia — 大三文鱼雕像打卡', tag: '景点', tagColor: TAG.activity, category: 'activity', imageUri: IMG.rakaia,
        description: '新西兰"喷射艇之都"，标志性的大三文鱼雕像是孩子的好拍照对象，旁边 Rakaia Domain 有小型游乐设施，面包房可买三文鱼派和热饮。' },
      { id: '2-4', time: '16:30', title: '抵达基督城，入住 Golden Hotel', tag: '抵达', tagColor: TAG.arrive, category: 'arrival', imageUri: IMG.chch_city,
  ...
  // ── Jun 3 ──────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      { id: '3-2', time: '11:30', title: '玛格丽特·马希游乐场 — 南半球最大', tag: '亲子', tagColor: TAG.activity, category: 'activity', imageUri: IMG.playground_mahy,
